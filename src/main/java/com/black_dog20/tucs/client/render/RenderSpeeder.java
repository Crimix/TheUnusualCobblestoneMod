...
public class RenderSpeeder extends Render {
	 ...
	 */
	public void doRender(EntityHoverBike p_76986_1_, double p_76986_2_,
		...
		this.modelBoat.render(p_76986_1_, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F,
				0.0625F);
		GL11.glPopMatrix();
	}
	 ...
	 */
	@Override
	public void doRender(Entity entity, double p_76986_2_, double p_76986_4_,
			double p_76986_6_, float p_76986_8_, float p_76986_9_) {
		this.doRender((EntityHoverBike) entity, p_76986_2_, p_76986_4_,
	...
	protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
		return new ResourceLocation(
				"tucs:textures/entity/Speeder-texturemap.png");
	}
