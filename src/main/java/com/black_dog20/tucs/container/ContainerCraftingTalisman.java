...
public class ContainerCraftingTalisman extends Container {
	...
	public ContainerCraftingTalisman(InventoryPlayer IPlayer, World world,
			int x, int y, int z, EntityPlayer eplayer) {
		this.worldObj = world;
	...
	public boolean canInteractWith(EntityPlayer player) {
		if (player.getHeldItem() != null) {
			boolean test = player.getHeldItem().isItemEqual(
					new ItemStack(ModItems.craftingTalisman));
