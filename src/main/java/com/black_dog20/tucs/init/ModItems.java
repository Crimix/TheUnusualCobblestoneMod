...
public class ModItems {
	...
	public static ToolMaterial COBBLESTONEDIUM_MATERIAL = EnumHelper
			.addToolMaterial("COBBLESTONEDIUM_MATERIAL", 3, 1692, 8.0F, 10.0F,
					22);
	public static ToolMaterial COBBLESTONEIUM_MATERIAL = EnumHelper
			.addToolMaterial("COBBLESTONEIUM_MATERIAL", 2, 381, 6.0F, 3.0F, 15);
	public static ArmorMaterial COBBLESTONEIUM_ARMORMATERIAL = EnumHelper
			.addArmorMaterial("Cobblestoneium", 17, new int[] { 3, 7, 6, 3 },
					10);
	public static ArmorMaterial COBBLESTONEdIUM_ARMORMATERIAL = EnumHelper
			.addArmorMaterial("Cobblestonedium", 66, new int[] { 4, 9, 7, 4 },
					0);
	public static ToolMaterial COBBLESTONEDIUM_UBER_MATERIAL = EnumHelper
			.addToolMaterial("COBBLESTONEDIUM_UBER_MATERIAL", 3, -100, 16.0F,
					20.0F, 22);
	...
	public static final ItemShovelCobblestoneium shovelCobblestoneium = new ItemShovelCobblestoneium(
			COBBLESTONEIUM_MATERIAL);
	public static final ItemSwordCobblestoneium swordCobblestoneium = new ItemSwordCobblestoneium(
			COBBLESTONEIUM_MATERIAL);
	public static final ItemHatchetCobblestoneium hatchetCobblestoneium = new ItemHatchetCobblestoneium(
			COBBLESTONEIUM_MATERIAL);
	public static final ItemHoeCobblestoneium hoeCobblestoneium = new ItemHoeCobblestoneium(
			COBBLESTONEIUM_MATERIAL);
	public static final ItemPickaxeCobblestoneium pickaxeCobblestoneium = new ItemPickaxeCobblestoneium(
			COBBLESTONEIUM_MATERIAL);
	public static final ItemHelmetCobblestoneium helmetCobblestoneium = new ItemHelmetCobblestoneium(
			COBBLESTONEIUM_ARMORMATERIAL, 0, "helmetCobblestoneium");
	public static final ItemLegCobblestoneium leggingsCobblestoneium = new ItemLegCobblestoneium(
			COBBLESTONEIUM_ARMORMATERIAL, 2, "leggingsCobblestoneium");
	public static final ItemBootCobblestoneium bootsCobblestoneium = new ItemBootCobblestoneium(
			COBBLESTONEIUM_ARMORMATERIAL, 3, "bootsCobblestoneium");
	public static final ItemChestplateCobblestoneium chestplateCobblestoneium = new ItemChestplateCobblestoneium(
			COBBLESTONEIUM_ARMORMATERIAL, 1, "chestplateCobblestoneium");

	// Cobblestondium armor
	public static final ItemHelmetCobblestonedium helmetCobblestonedium = new ItemHelmetCobblestonedium(
			COBBLESTONEdIUM_ARMORMATERIAL, 0, "helmetCobblestonedium");
	public static final ItemLegCobblestonedium leggingsCobblestonedium = new ItemLegCobblestonedium(
			COBBLESTONEdIUM_ARMORMATERIAL, 2, "leggingsCobblestonedium");
	public static final ItemBootCobblestonedium bootsCobblestonedium = new ItemBootCobblestonedium(
			COBBLESTONEdIUM_ARMORMATERIAL, 3, "bootsCobblestonedium");
	public static final ItemChestplateCobblestonedium chestplateCobblestonedium = new ItemChestplateCobblestonedium(
			COBBLESTONEdIUM_ARMORMATERIAL, 1, "chestplateCobblestonedium");
	public static final ItemHelmetCobblestonedium_Scuba helmetCobblestonedium_scuba = new ItemHelmetCobblestonedium_Scuba(
			COBBLESTONEdIUM_ARMORMATERIAL, 0, "helmetCobblestonedium_scuba");
	public static final ItemChestplateCobblestonedium_scuba chestplateCobblestonedium_scuba = new ItemChestplateCobblestonedium_scuba(
			COBBLESTONEdIUM_ARMORMATERIAL, 1, "chestplateCobblestonedium_scuba");
	...
	public static final ItemScubaMask ScubaMask = new ItemScubaMask(
			ArmorMaterial.IRON, 0, "scubaMask");
	public static final ItemAirTank AirTank = new ItemAirTank(
			ArmorMaterial.IRON, 1, "airtank");
	...
	public static final ItemTUCS Tier1CraftingMat = new ItemTUCS(
			"tier1CraftingMat");
	public static final ItemTUCS Tier2CraftingMat = new ItemTUCS(
			"tier2CraftingMat");
	public static final ItemTUCS Tier3CraftingMat = new ItemTUCS(
			"tier3CraftingMat");
	...
	// Tools
	public static final ItemTLBOTB TLBOTB = new ItemTLBOTB(
			COBBLESTONEDIUM_MATERIAL);
	public static final ItemTLHOWF TLHOWF = new ItemTLHOWF(
			COBBLESTONEDIUM_MATERIAL);
	public static final ItemTLSOHD TLSOHD = new ItemTLSOHD(
			COBBLESTONEDIUM_MATERIAL);
	public static final ItemTLPOLM TLPOLM = new ItemTLPOLM(
			COBBLESTONEDIUM_MATERIAL);
	public static final ItemTLSOC TLSOC = new ItemTLSOC(
			COBBLESTONEDIUM_MATERIAL);
	public static final ItemTLSOTD TLSOTD = new ItemTLSOTD(
			COBBLESTONEDIUM_UBER_MATERIAL);
	...
	public static final ItemLootingUpgrade looting1Upgrade = new ItemLootingUpgrade(
			1);
	public static final ItemLootingUpgrade looting2Upgrade = new ItemLootingUpgrade(
			2);
	public static final ItemLootingUpgrade looting3Upgrade = new ItemLootingUpgrade(
			3);
	public static final ItemSoulboundUpgrade soulboundUpgrade = new ItemSoulboundUpgrade();
	public static final ItemSharpnessUpgrade Sharpness1Upgrade = new ItemSharpnessUpgrade(
			1);
	public static final ItemSharpnessUpgrade Sharpness2Upgrade = new ItemSharpnessUpgrade(
			2);
	public static final ItemSharpnessUpgrade Sharpness3Upgrade = new ItemSharpnessUpgrade(
			3);
	public static final ItemSharpnessUpgrade Sharpness4Upgrade = new ItemSharpnessUpgrade(
			4);
	public static final ItemSharpnessUpgrade Sharpness5Upgrade = new ItemSharpnessUpgrade(
			5);
	...
	public static final ItemEfficiencyUpgrade Efficiency1Upgrade = new ItemEfficiencyUpgrade(
			1);
	public static final ItemEfficiencyUpgrade Efficiency2Upgrade = new ItemEfficiencyUpgrade(
			2);
	public static final ItemEfficiencyUpgrade Efficiency3Upgrade = new ItemEfficiencyUpgrade(
			3);
	public static final ItemEfficiencyUpgrade Efficiency4Upgrade = new ItemEfficiencyUpgrade(
			4);
	public static final ItemEfficiencyUpgrade Efficiency5Upgrade = new ItemEfficiencyUpgrade(
			5);
	...
	public static final ItemFireAspectUpgrade FireAspect1Upgrade = new ItemFireAspectUpgrade(
			1);
	public static final ItemFireAspectUpgrade FireAspect2Upgrade = new ItemFireAspectUpgrade(
			2);
	public static final ItemKnockbackUpgrade Knockback1Upgrade = new ItemKnockbackUpgrade(
			1);
	public static final ItemKnockbackUpgrade Knockback2Upgrade = new ItemKnockbackUpgrade(
			2);
	public static final ItemSliktouchUpgrade Sliktouch1Upgrade = new ItemSliktouchUpgrade(
			1);
	public static final ItemUnbreakingUpgrade Unbreaking1Upgrade = new ItemUnbreakingUpgrade(
			1);
	public static final ItemUnbreakingUpgrade Unbreaking2Upgrade = new ItemUnbreakingUpgrade(
			2);
	public static final ItemUnbreakingUpgrade Unbreaking3Upgrade = new ItemUnbreakingUpgrade(
			3);
	...
	public static final ItemAquaAffinityUpgrade AquaAffinityUpgrade = new ItemAquaAffinityUpgrade(
			1);
	public static final ItemBlastProtectionUpgrade BlastProtection1Upgrade = new ItemBlastProtectionUpgrade(
			1);
	public static final ItemBlastProtectionUpgrade BlastProtection2Upgrade = new ItemBlastProtectionUpgrade(
			2);
	public static final ItemBlastProtectionUpgrade BlastProtection3Upgrade = new ItemBlastProtectionUpgrade(
			3);
	public static final ItemBlastProtectionUpgrade BlastProtection4Upgrade = new ItemBlastProtectionUpgrade(
			4);
	public static final ItemFeatherFallingUpgrade FeatherFalling1Upgrade = new ItemFeatherFallingUpgrade(
			1);
	public static final ItemFeatherFallingUpgrade FeatherFalling2Upgrade = new ItemFeatherFallingUpgrade(
			2);
	public static final ItemFeatherFallingUpgrade FeatherFalling3Upgrade = new ItemFeatherFallingUpgrade(
			3);
	public static final ItemFeatherFallingUpgrade FeatherFalling4Upgrade = new ItemFeatherFallingUpgrade(
			4);
	public static final ItemFireProtectionUpgrade FireProtection1Upgrade = new ItemFireProtectionUpgrade(
			1);
	public static final ItemFireProtectionUpgrade FireProtection2Upgrade = new ItemFireProtectionUpgrade(
			2);
	public static final ItemFireProtectionUpgrade FireProtection3Upgrade = new ItemFireProtectionUpgrade(
			3);
	public static final ItemFireProtectionUpgrade FireProtection4Upgrade = new ItemFireProtectionUpgrade(
			4);
	...
	public static final ItemProjectileProtectionUpgrade ProjectileProtection1Upgrade = new ItemProjectileProtectionUpgrade(
			1);
	public static final ItemProjectileProtectionUpgrade ProjectileProtection2Upgrade = new ItemProjectileProtectionUpgrade(
			2);
	public static final ItemProjectileProtectionUpgrade ProjectileProtection3Upgrade = new ItemProjectileProtectionUpgrade(
			3);
	public static final ItemProjectileProtectionUpgrade ProjectileProtection4Upgrade = new ItemProjectileProtectionUpgrade(
			4);
	public static final ItemProtectionUpgrade Protection1Upgrade = new ItemProtectionUpgrade(
			1);
	public static final ItemProtectionUpgrade Protection2Upgrade = new ItemProtectionUpgrade(
			2);
	public static final ItemProtectionUpgrade Protection3Upgrade = new ItemProtectionUpgrade(
			3);
	public static final ItemProtectionUpgrade Protection4Upgrade = new ItemProtectionUpgrade(
			4);
	...
	public static final ItemRespirationUpgrade Respiration1Upgrade = new ItemRespirationUpgrade(
			1);
	public static final ItemRespirationUpgrade Respiration2Upgrade = new ItemRespirationUpgrade(
			2);
	public static final ItemRespirationUpgrade Respiration3Upgrade = new ItemRespirationUpgrade(
			3);
	public static final ItemThornsUpgrade Thorns1Upgrade = new ItemThornsUpgrade(
			1);
	public static final ItemThornsUpgrade Thorns2Upgrade = new ItemThornsUpgrade(
			2);
	public static final ItemThornsUpgrade Thorns3Upgrade = new ItemThornsUpgrade(
			3);
	...
	public static void init() {
		...
		TucsRegistry.registerItem(hatchetCobblestoneium,
				"hatchetCobblestoneium");
		TucsRegistry.registerItem(hoeCobblestoneium, "hoeCobblestoneium");
		TucsRegistry.registerItem(pickaxeCobblestoneium,
				"pickaxeCobblestoneium");

		// ARMOR
		TucsRegistry.registerItem(helmetCobblestoneium, "helmetCobblestoneium");
		TucsRegistry.registerItem(leggingsCobblestoneium,
				"leggingsCobblestoneium");
		TucsRegistry.registerItem(bootsCobblestoneium, "bootsCobblestoneium");
		TucsRegistry.registerItem(chestplateCobblestoneium,
				"chestplateCobblestoneium");
		TucsRegistry.registerItem(helmetCobblestonedium,
				"helmetCobblestonedium");
		TucsRegistry.registerItem(leggingsCobblestonedium,
				"leggingsCobblestonedium");
		TucsRegistry.registerItem(bootsCobblestonedium, "bootsCobblestonedium");
		TucsRegistry.registerItem(chestplateCobblestonedium,
				"chestplateCobblestonedium");
		TucsRegistry.registerItem(ScubaMask, "scubaMask");
		TucsRegistry.registerItem(AirTank, "AirTank");
		TucsRegistry.registerItem(helmetCobblestonedium_scuba,
				"helmetCobblestonedium_scuba");
		TucsRegistry.registerItem(chestplateCobblestonedium_scuba,
				"chestplateCobblestonedium_scuba");
		...
		TucsRegistry.registerItem(cobblestonediumLighter,
				"cobblestonediumLighter");
		TucsRegistry.registerItem(cobblestoneiumLighter,
				"cobblestoneiumLighter");
		...
		TucsRegistry.registerItem(helmetCobblestonediumBroken,
				"helmetCobblestonediumBroken");
		TucsRegistry.registerItem(leggingsCobblestonediumBroken,
				"leggingsCobblestonediumBroken");
		TucsRegistry.registerItem(bootsCobblestonediumBroken,
				"bootsCobblestonediumBroken");
		TucsRegistry.registerItem(chestplateCobblestonediumBroken,
				"chestplateCobblestonediumBroken");
		...
		TucsRegistry.registerItem(BlastProtection1Upgrade,
				"BlastProtection1Upgrade");
		TucsRegistry.registerItem(BlastProtection2Upgrade,
				"BlastProtection2Upgrade");
		TucsRegistry.registerItem(BlastProtection3Upgrade,
				"BlastProtection3Upgrade");
		TucsRegistry.registerItem(BlastProtection4Upgrade,
				"BlastProtection4Upgrade");
		TucsRegistry.registerItem(FeatherFalling1Upgrade,
				"FeatherFalling1Upgrade");
		TucsRegistry.registerItem(FeatherFalling2Upgrade,
				"FeatherFalling2Upgrade");
		TucsRegistry.registerItem(FeatherFalling3Upgrade,
				"FeatherFalling3Upgrade");
		TucsRegistry.registerItem(FeatherFalling4Upgrade,
				"FeatherFalling4Upgrade");
		TucsRegistry.registerItem(FireProtection1Upgrade,
				"FireProtection1Upgrade");
		TucsRegistry.registerItem(FireProtection2Upgrade,
				"FireProtection2Upgrade");
		TucsRegistry.registerItem(FireProtection3Upgrade,
				"FireProtection3Upgrade");
		TucsRegistry.registerItem(FireProtection4Upgrade,
				"FireProtection4Upgrade");
		...
		TucsRegistry.registerItem(ProjectileProtection1Upgrade,
				"ProjectileProtection1Upgrade");
		TucsRegistry.registerItem(ProjectileProtection2Upgrade,
				"ProjectileProtection2Upgrade");
		TucsRegistry.registerItem(ProjectileProtection3Upgrade,
				"ProjectileProtection3Upgrade");
		TucsRegistry.registerItem(ProjectileProtection4Upgrade,
				"ProjectileProtection4Upgrade");
		...
		TucsRegistry.registerItem(UnfinshedFlightTalisman,
				"UnfinshedFlightTalisman");
		TucsRegistry.registerItem(ungoldenFligtTalisman,
				"ungoldenFligtTalisman");
