...
public class ItemChestplateCobblestonedium extends ItemUpgradableArmorTUCS {

	public ItemChestplateCobblestonedium(ArmorMaterial Material, int armortype, String Name) {
